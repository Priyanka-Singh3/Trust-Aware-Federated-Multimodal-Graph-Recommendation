...
where the GNN incorporates \textbf{256-dimensional embeddings} with 4-head attention mechanisms and is trained for 200 epochs with adaptive learning rate scheduling.
...
\midrule
\textbf{T-FedMMG (Ours)} & \textbf{0.1848} & \textbf{0.0970} \\ \hlinebottomrule
\end{tabular}
\end{table}
\vspace{0.5em}
...
\midrule
Accuracy (HR@10) & 0.1848 & $>$0.15 & Good \\
NDCG@10 & 0.0970 & $>$0.08 & Good \\
Catalog Coverage & 6.97\% & $>$30\% & Good \\
Training Convergence & 200 epochs & 100+ & Perfect \\
