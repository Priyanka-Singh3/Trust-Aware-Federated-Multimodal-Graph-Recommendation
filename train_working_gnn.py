#!/usr/bin/env python3
"""
Working Enhanced GNN Training - Fixed Version
=====================================
This script implements a working enhanced GNN model with:
...
class WorkingEnhancedGNN(nn.Module):
    """
    Working enhanced GNN with proper tensor handling
    """
    ...
    def __init__(self, num_users: int, num_items: int, 
        ...
        for i in range(num_layers):
            if i == 0:
                input_dim = user_dim + item_dim  # user+item features
            else:
...
def train_working_gnn(model, user_ids, item_ids, text_feats, item_img_feats,
                      train_mask, num_items, epochs=200, batch_size=512,
                      lr=1e-3, weight_decay=1e-5):
    """Train working enhanced GNN"""
    ...
    for epoch in range(1, epochs + 1):
        ...
        if mean_loss < best_loss:
            best_loss = mean_loss
            torch.save(model.state_dict(), '/Users/priyankasingh/Documents/BTP-8/best_working_gnn.pt')
    
    model.eval()
    print(f"\\n✅ Working Enhanced GNN training complete! Best loss: {best_loss:.4f}\\n")
    return
...
def main():
    ...
    print("=" * 70)
    print("WORKING ENHANCED GNN TRAINING - FIXED VERSION")
    print("=" * 70)
    ...
    # Initialize working enhanced GNN
    model = WorkingEnhancedGNN(
    ...
    print(f"📊 Working Enhanced GNN Model initialized:")
    ...
    # Evaluate working enhanced model
    print("🔍 Evaluating working enhanced GNN model...")
    ...
    print("\\n" + "=" * 70)
    print("WORKING ENHANCED GNN RESULTS")
    print("=" * 70)
    ...
    print("\\n🎯 Working Enhanced GNN Performance Summary:")
    ...
    # Save results
    with open('/Users/priyankasingh/Documents/BTP-8/working_gnn_results.txt', 'w') as f:
        f.write("Working Enhanced GNN Training Results\\n")
        f.write("=" * 40 + "\\n")
